    ...
    <div class="main">
        <div class="body">
            <div>
                ...
                <a href="{{ route('contratosAtivos') }}" class="botao">Lista de ativos</a>

                <a href="{{ route('admin.contrato.create') }}" class="botao">Novo contrato</a>
                    ...
                    <tbody>
                        @foreach ($listaContrato as $contrato)
                            <tr>
                                ...
                                <td class="editar"><a href="{{ route('admin.contrato.edit', $contrato->idContrato) }}">Editar</a></td>
                                <td>
                                    <form action="{{ route('admin.contrato.desativar', $contrato->idContrato) }}" method="POST">
                                        @csrf
                                        @method('PUT')
